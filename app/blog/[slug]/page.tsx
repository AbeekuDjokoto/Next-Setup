...
const portableTextComponents = {
  ...
  block: {
    ...
    h2: ({ children }: any) => <h2 className="mb-[0.8rem]">{children}</h2>,
    h3: ({ children }: any) => <h3 className="mb-[0.8rem]">{children}</h3>,
    h4: ({ children }: any) => <h4 className="mb-[0.8rem]">{children}</h4>,
    h5: ({ children }: any) => <h5 className="mb-[0.8rem]">{children}</h5>,
